...
const copy = {
  waitlist: {
    ...
    body: `The first ${siteConfig.pricing.dayOneCap} listeners lock £${siteConfig.pricing.dayOne} a month for as long as they stay subscribed. After that, RAAYDR is £${siteConfig.pricing.standard}. You were early. On RAAYDR, that counts.`,
    micro:
    ...
    <section id="join" className={styles.section} aria-labelledby="join-heading">
      ...
      <div ref={innerRef} className={`container ${styles.inner}`}>
        ...
        <div className={styles.form} data-reveal>
          <WaitlistForm variant="closing" source="homepage-bottom" showOffer />
        </div>
